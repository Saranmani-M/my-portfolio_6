...
export const Hero = () => {
  return (
    ...
    >
      {/* Right-side dramatic portrait */}
      <motion.div
        initial={{ opacity: 0, scale: 1.05 }}
        animate={{ opacity: 1, scale: 1 }}
        transition={{ duration: 1.6, ease: easeOut }}
        className="absolute inset-y-0 right-0 w-full md:w-[58%] lg:w-[55%] z-0"
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 80% 40%, rgba(232,255,71,0.06), transparent 60%)",
          }}
        />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10 lg:px-12 pt-28 md:pt-32 pb-16 md:pb-20 min-h-[100svh] flex flex-col">
        ...
        <motion.div
          ...
          className="max-w-[640px] mt-6 md:mt-10"
        >
          {/* Open to work mini-badge */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        {/* Spacer pushes lower content down */}
        <div className="flex-1 min-h-[40px]" />

        {/* Lower content: greeting + description + socials */}
